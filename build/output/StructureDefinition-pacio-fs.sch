...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'https://paciowg.github.io/functional-status-ig/StructureDefinition/grouping-order']) &lt;= 1">extension with URL = 'https://paciowg.github.io/functional-status-ig/StructureDefinition/grouping-order': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://paciowg.github.io/functional-status-ig/StructureDefinition/grouping-name']) &lt;= 1">extension with URL = 'https://paciowg.github.io/functional-status-ig/StructureDefinition/grouping-name': maximum cardinality of 'extension' is 1</sch:assert>
